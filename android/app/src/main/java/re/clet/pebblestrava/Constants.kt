...
object Constants {
    val APP_UUID: UUID = UUID.fromString("136a1e15-7d76-4072-8046-fd01c7562f82")
    ...
    const val PREF_DOWNLOAD_SUBFOLDER   = "download_subfolder"   // subfolder name under Downloads/
